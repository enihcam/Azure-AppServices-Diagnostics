import logging, asyncio, sys, json, os
...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if req_data:
        ...
        if "trainingConfig" in req_data:
            ...
            if trainingConfig.useWord2Vec and not Path(os.path.join(appSettings.WORD2VEC_PATH, appSettings.WORD2VEC_MODEL_NAME)).exists():
                await sah.downloadFile("word2vec/GoogleNews-vectors-negative300.bin", appSettings.WORD2VEC_PATH)
